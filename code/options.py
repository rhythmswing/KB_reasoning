...
def read_options():
    ...
    parser.add_argument("--data_input_dir", default="../datasets/data_preprocessed/countries_S3/", type=str)
    parser.add_argument("--input_file", default="train.txt", type=str)
    parser.add_argument("--create_vocab", default=0, type=int)
    parser.add_argument("--vocab_dir", default="../datasets/data_preprocessed/countries_S3/vocab", type=str)
    ...
    parser.add_argument("--model_dir", default='nothing', type=str)
    parser.add_argument("--base_output_dir", default='output/countries_s3/', type=str)
    parser.add_argument("--total_iterations", default=1000, type=int)
