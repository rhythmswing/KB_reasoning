...
class Episode(object):
    def __init__(self, graph, data, params):
        self.grapher = graph
        # (from the definition) params = self.batch_size, self.path_len, self.num_rollouts, self.test_rollouts, self.positive_reward, self.negative_reward, self.mode, self.batcher
        ...
        self.current_hop = 0
        start_entities, query_relation, end_entities, all_answers = data #data: e1, r, e2, all_e2s
